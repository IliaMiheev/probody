...
get_telemetry = rospy.ServiceProxy('get_telemetry', srv.GetTelemetry) #сервис для получения местонахождения
navigate = rospy.ServiceProxy('navigate', srv.Navigate) #сервис для полета по указанным координатам
